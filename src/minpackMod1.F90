module minpackmod1
  ...
  interface 
    subroutine fcnHybrd1( neq, x, fvec, iflag )
      implicit none
      integer          :: neq, iflag
      double precision :: x(neq), fvec(neq)
    end subroutine
    subroutine fcnLmder ( m, n, x, fvec, fjac, ldfjac, iflag )
    ...
    subroutine fcnHybrj ( n, x, fvec, fjac, ldfjac, iflag )
      implicit none
      integer ( kind = 4 ) ldfjac
      integer ( kind = 4 ) n
      real( kind = 8 ) fjac(ldfjac,n)
    ...
    subroutine fcnFdjac2 ( m, n, x, fvec, iflag )
      implicit none
      integer ( kind = 4 ) m
      integer ( kind = 4 ) n
      real( kind = 8 ) fvec(m)
    ...
    subroutine fcnLmstr ( m, n, x, fvec, fjrow, iflag )
      implicit none
      integer ( kind = 4 ) m
      integer ( kind = 4 ) n
      real( kind = 8 ) fjrow(n)
