...
!teste hidrodinâmico: interative blast wave problem (IBWS)
! [1]   R. Borges, M. Carmona, B. Costa, and W. S. Don,
!  Journal of Computational Physics 227, 3191 (2008).
! gamma = 1.4d0, t = 0.038, N = 400 lenght = 1
! [2]   G.-S. Jiang and C.-W. Shu, J]
!       Journal of Computational Physics 126, 202 (1996).
! ! gamma = 1.4d0, t = 0.038, N = 400 lenght = 1
...
!==============================================================================
  ...
  allocate(css(jm))
   ...
   DO i = jbeg,jend 
    ...
    ELSE IF(yc(i) .GE. ymax*0.9d0) THEN
...
!     ELSE IF(xc(i) .GE. xmax*0.9d0) THEN
